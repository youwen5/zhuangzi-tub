...
var OrbitControls = class extends EventDispatcher {
	constructor(object, domElement) {
		...
		this.dispose = function() {
			...
			scope.domElement.getRootNode().removeEventListener("keydown", interceptControlDown, { capture: true });
		...
		function isTrackingPointer(event) {
			for (let i = 0; i < pointers.length; i++) if (pointers[i] == event.pointerId) return true;
			return false;
		}
